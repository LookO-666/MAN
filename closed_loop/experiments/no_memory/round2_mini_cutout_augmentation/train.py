...
parser.add_argument('--cutout_length', default=16, type=int, help='cutout patch length')
parser.add_argument('--cutout_n_holes', default=1, type=int, help='number of cutout holes')
...
transform_train = transforms.Compose([
    ...
    Cutout(n_holes=args.cutout_n_holes, length=args.cutout_length),
])
