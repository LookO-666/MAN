...
parser.add_argument('--mixup_alpha', default=1.0, type=float, help='mixup alpha parameter')
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        # For accuracy calculation, we use the original targets (targets_a) with weight lam
