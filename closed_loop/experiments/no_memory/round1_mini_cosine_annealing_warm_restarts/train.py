...
parser.add_argument('--T_0', default=50, type=int, help='Number of epochs for the first restart')
parser.add_argument('--T_mult', default=2, type=int, help='A factor increases T_i after a restart')
